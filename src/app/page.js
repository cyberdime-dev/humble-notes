...
export default function Home() {
  const { signInWithGoogle, signInWithGitHub, signUpWithEmail, signInWithEmail, resetPassword, user, loading } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-custom flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl shadow-lg mb-6">
            <img src="/favicon.svg" alt="Humble Notes" className="w-16 h-16" />
          </div>
        </div>
        ...
        <button
          ...
          disabled={authLoading}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-gray-900 hover:bg-gray-800 text-white border border-gray-700 transition-all duration-200 shadow-sm hover:shadow-md group mb-4"
        >
        ...
        <button
          ...
          disabled={authLoading}
          className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-custom-button hover:bg-custom-button border border-zinc-200 dark:border-zinc-700 transition-all duration-200 shadow-sm hover:shadow-md group mb-4"
        >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-gradient-custom text-custom-secondary">or continue with email</span>
          </div>
        </div>
